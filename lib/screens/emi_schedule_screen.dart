...
class EMIScheduleScreenState extends State<EMIScheduleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.emiSchedule),
        elevation: 0,
      ),
      body: Column(
        children: [
            ...
            child: Column(
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    labelText: AppLocalizations.of(context)!.filterByCustomer,
                    prefixIcon: Icon(
                      Icons.filter_list,
                      color: AppTheme.primaryBlue,
                    ),
                  ...
                  items: [
                    DropdownMenuItem<String>(
                      value: null,
                      child: Text(
                        AppLocalizations.of(context)!.allCustomersLabel,
                      ),
                    ),
                    ..._customers.map((customer) {
                      return DropdownMenuItem<String>(
                        value: customer.id,
                        child: Text(
                          '${localizedText(context, customer.name)} (${customer.mobile})',
                        ),
                      );
                    }),
                  ],
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        '${AppLocalizations.of(context)!.loanAmount}: ₹${loan.amount.toStringAsFixed(2)} • ${loan.tenure} ${AppLocalizations.of(context)!.months}',
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodySmall
                                            ?.copyWith(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            AppLocalizations.of(context)!.noEMISchedulesFound,
            style: Theme.of(
              context,
  ...
  Future<void> _markAsPaid(EMISchedule emi) async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context)!.emiMarkedAsPaid),
            backgroundColor: AppTheme.secondaryGreen,
